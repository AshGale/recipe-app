package co.uk.boot.guru.recipeapp.bootstarp;

import co.uk.boot.guru.recipeapp.domain.*;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipies() {
        ...
        Optional<UnitOfMeasure> tableSpoonsUomOptional = unitOfMeasureRepository.findByDescription("TableSpoons");
        if(!tableSpoonsUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Found");
        }

        Optional<UnitOfMeasure> teaspoonsUomOptional = unitOfMeasureRepository.findByDescription("Teaspoons");
        if(!teaspoonsUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Found");
        }

        Optional<UnitOfMeasure> pintsUomOptional = unitOfMeasureRepository.findByDescription("Pints");
        if(!pintsUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Found");
        }
        ...
        Optional<UnitOfMeasure> dashesUomOptional = unitOfMeasureRepository.findByDescription("Dashes");
        if(!dashesUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Found");
        }
        ...
        UnitOfMeasure dashUom = dashesUomOptional.get();
        ...
        tacosRecipe.getCategories().add(spicyCategory);
